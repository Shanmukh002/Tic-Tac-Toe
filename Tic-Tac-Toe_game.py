# Importing the required randrange function from random module
...
# This function checks the free blocks from the board
...
# It decides winner based on the present move
...
# Request the user to select the block
...
# A random number is selected as move for the computer
def draw_move(board):
...
# Until the blocks are free the game will run
while len(free):
	display_board(board)
	if human_turn:
		enter_move(board)
